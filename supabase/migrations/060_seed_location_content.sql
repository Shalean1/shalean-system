...
-- ============================================================================
-- Migration: Seed location_content table with unique, SEO-optimized content for all locations
-- Created: 2025-01-XX
-- Description: Populates location_content with unique content for each active service location
