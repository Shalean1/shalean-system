...
import ChangeInfoForm from "@/components/cleaner/ChangeInfoForm";

export default async function CleanerChangeInfoPage() {
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="mb-8">
          ...
          <p className="text-base md:text-lg text-gray-600">
            Let us help you - What is your query?
          </p>
        </div>

        {/* Change Info Form */}
        <ChangeInfoForm initialProfile={profile} userEmail={user.email || ""} cancelLink="/cleaner" />
      </div>
    </div>
  );
}
