...
export default function PriceSummary({
  ...
  // Render pricing breakdown section
  ...
  return (
    <>
      <div className="bg-white border border-gray-200 rounded-xl p-6 sticky top-24">
        ...
        {/* Mobile: Show only Total with arrow */}
      ...
      {isSheetOpen && (
        <>
          ...
          />
          {/* Sheet */}
          <div className="fixed bottom-0 left-0 right-0 bg-white rounded-t-2xl shadow-2xl z-50 md:hidden max-h-[90vh] overflow-y-auto transform transition-transform duration-300 ease-out">
